    ...
    <form id="myform" action="jsp/student_add.jsp" method="post" >
      <table border="1">
         <tr>
           ...
           <td>
              <input style=" font-size:24" type="radio" name="xbie"  value="男" checked/>男
              <input style=" font-size:24" type="radio" name="xbie" value="女" />女
           </td>
         ...
         <tr>
           ...
           <td>
              <select name="xyuan" style="font-size:24">
           ...
           <td>
              <input type="text" name="zhye" style=" font-size:24" />
